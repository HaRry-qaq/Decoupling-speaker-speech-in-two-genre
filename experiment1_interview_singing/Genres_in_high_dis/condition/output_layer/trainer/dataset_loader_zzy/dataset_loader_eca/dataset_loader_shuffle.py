...
class Train_Dataset(Dataset):
    def __init__(self, data_list_path, augment, musan_list_path, rirs_list_path, condition_list_path,max_frames):

        # load data list
        self.data_list_path = data_list_path
        self.condition_list_path=condition_list_path
    ...
    def __getitem__(self, index):
        ...
        condition = df2[self.data_list[index]].values
